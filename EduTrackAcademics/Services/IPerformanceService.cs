...
namespace EduTrackAcademics.Services
{
...

    {
      ...
      //  Task<StudentAssessmentStatsDTO> GetStudentAssessmentStatsAsync(string studentId);

        Task<List<StudentAssessmentStatsDTO>> GetStudentAssessmentStatsAsync(string studentId);
